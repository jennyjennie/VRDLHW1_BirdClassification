...
def write_training_info_txtfile(phase, epochs, trained_epochs, 
    ...
    file_path = PARENT_PATH + 'train_results/training_results_' + filetag + '.txt'
...
def main():
    ...
    IS_RESUME_TRAINIG = False if args.model_name_resume_path == None else True

    model_ft = train_model(model, criterion, optimizer_ft, exp_lr_scheduler,
                           checkPointStore, IS_RESUME_TRAINIG, num_epochs=args.num_epoch)
